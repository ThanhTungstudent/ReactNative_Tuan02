...
// Bai 6
Promise.all([(0, promise_1.simulateTask)(1000), (0, promise_1.simulateTask)(2000), (0, promise_1.simulateTask)(3000)])
    .then((results) => console.log("6: All results ", results));
// Bai 7
Promise.race([(0, promise_1.simulateTask)(1000), (0, promise_1.simulateTask)(2000), (0, promise_1.simulateTask)(3000)])
